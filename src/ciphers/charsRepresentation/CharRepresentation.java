...
public class CharRepresentation implements Serializable {
    private boolean[] thereAreBoards;
    private boolean[] thereArePoints ;

    public CharRepresentation(boolean[] thereAreBoards, boolean[] thereArePoints) {
        this.thereAreBoards = thereAreBoards;
        this.thereArePoints = thereArePoints;
    }
    public CharRepresentation() {
    ...
    public boolean equals(Object o) {
        ...
        CharRepresentation that = (CharRepresentation) o;
